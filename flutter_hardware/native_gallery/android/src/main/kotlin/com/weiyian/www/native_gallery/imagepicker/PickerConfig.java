...
public class PickerConfig {
    ...
    public static final String AllOW_SELECT_ORIGINAL = "allowSelectOriginal";
    public static final String AllOW_EDIT_IMAGE = "allowEditImage";
//    public static final String AllOW_SELECT_IMAGE = "allowSelectImage";
//    public static final String AllOW_SELECT_VIDEO = "allowSelectVideo";
    public static final String AllOW_CHOSE_PHOTO_AND_VIDEO = "allowChoosePhotoAndVideo";
