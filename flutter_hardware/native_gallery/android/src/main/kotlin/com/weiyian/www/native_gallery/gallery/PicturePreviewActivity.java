...
import com.weiyian.www.native_gallery.imagecrop.Crop;
...
public class PicturePreviewActivity extends Activity implements View.OnClickListener {
    ...
    private boolean canImageEdit = false;
    private boolean allowSelectOriginal = false;
...
//                }
    ...
    private void getIntentExtra() {
        ...
        allowSelectOriginal = getIntent().getBooleanExtra(GalleryConfig.ALLOW_SELECT_ORIGINAL, false);
        canImageEdit = getIntent().getBooleanExtra(GalleryConfig.CAN_IMAGE_EDIT, false);
    ...
    private void initView() {
        ...
        cropEdit.setVisibility(canImageEdit ? View.VISIBLE : View.GONE);
        ...
        previewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int positions) {
                ...
                if (images != null && images.size() > 0) {
                    ...
                    cropEdit.setVisibility(canImageEdit && !isVideo(mediaType) ? View.VISIBLE : View.GONE);
    ...
    private void initCommitBtn() {
        if (mImageSelected != null) {
            if (mImageSelected.size() > 0) {
                tvOk.setText("完成" + "(" + mImageSelected.size() + ")");
                tvOk.setBackground(getResources().getDrawable(R.drawable.sure_chose_bg));
                tvOk.setEnabled(true);
            } else {
                tvOk.setText("完成");
                tvOk.setBackground(getResources().getDrawable(R.drawable.sure_normal_bg));
