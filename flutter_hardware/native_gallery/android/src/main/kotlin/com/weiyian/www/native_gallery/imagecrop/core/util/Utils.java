package com.weiyian.www.native_gallery.imagecrop.core.util;
...
public class Utils {
    ...
    public static CropHoming fitHoming(RectF win, RectF frame) {
        CropHoming dHoming = new CropHoming(0, 0, 1, 0);
    ...
    public static CropHoming fitHoming(RectF win, RectF frame, float centerX, float centerY) {
        CropHoming dHoming = new CropHoming(0, 0, 1, 0);
    ...
    public static CropHoming fitHoming(RectF win, RectF frame, boolean isJustInner) {
        CropHoming dHoming = new CropHoming(0, 0, 1, 0);
    ...
    public static CropHoming fillHoming(RectF win, RectF frame) {
        CropHoming dHoming = new CropHoming(0, 0, 1, 0);
        if (frame.contains(win)) {
            // 不需要Fill
            return dHoming;
    ...
    public static CropHoming fillHoming(RectF win, RectF frame, float pivotX, float pivotY) {
        CropHoming dHoming = new CropHoming(0, 0, 1, 0);
        if (frame.contains(win)) {
            // 不需要Fill
            return dHoming;
    ...
    public static CropHoming fill(RectF win, RectF frame) {
        CropHoming dHoming = new CropHoming(0, 0, 1, 0);
