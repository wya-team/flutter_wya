...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    public boolean animateChange(RecyclerView.ViewHolder oldHolder, RecyclerView.ViewHolder newHolder,
        ...
        mPendingChanges.add(new DefaultItemAnimator.ChangeInfo(oldHolder, newHolder, fromX, fromY, toX, toY));
        return true;
    }
    ...
    private void endChangeAnimation(List<DefaultItemAnimator.ChangeInfo> infoList, RecyclerView.ViewHolder item) {
        for (int i = infoList.size() - 1; i >= 0; i--) {
            DefaultItemAnimator.ChangeInfo changeInfo = infoList.get(i);
    ...
    public void endAnimation(RecyclerView.ViewHolder item) {
        ...
        for (int i = mPendingMoves.size() - 1; i >= 0; i--) {
            DefaultItemAnimator.MoveInfo moveInfo = mPendingMoves.get(i);
        ...
        for (int i = mChangesList.size() - 1; i >= 0; i--) {
            ArrayList<DefaultItemAnimator.ChangeInfo> changes = mChangesList.get(i);
        ...
        for (int i = mMovesList.size() - 1; i >= 0; i--) {
            ArrayList<DefaultItemAnimator.MoveInfo> moves = mMovesList.get(i);
    ...
    public void endAnimations() {
        ...
        for (int i = count - 1; i >= 0; i--) {
            DefaultItemAnimator.MoveInfo item = mPendingMoves.get(i);
