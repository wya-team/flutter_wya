package com.weiyian.www.native_gallery.imagecrop.view;
...
public class EditColorRadio extends RadioButton implements ValueAnimator.AnimatorUpdateListener {
    ...
    public EditColorRadio(Context context, AttributeSet attrs) {
        super(context, attrs);
        initialize(context, attrs, 0);
    }
    
    public EditColorRadio(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initialize(context, attrs, defStyleAttr);
    }
    
    private void initialize(Context context, AttributeSet attrs, int defStyleAttr) {
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.EditColorRadio);
        
        mColor = a.getColor(R.styleable.EditColorRadio_image_color, Color.WHITE);
        mStrokeColor = a.getColor(R.styleable.EditColorRadio_image_stroke_color, Color.WHITE);
