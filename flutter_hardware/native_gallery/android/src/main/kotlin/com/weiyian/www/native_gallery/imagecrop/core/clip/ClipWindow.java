package com.weiyian.www.native_gallery.imagecrop.core.clip;
...
public class ClipWindow implements Clip {
    ...
    private void reset(float clipWidth, float clipHeight) {
        ...
        Utils.fitCenter(mWinFrame, mFrame, CLIP_MARGIN);
        mTargetFrame.set(mFrame);
    }
    ...
    public boolean homing() {
        ...
        mTargetFrame.set(mFrame);
        Utils.fitCenter(mWinFrame, mTargetFrame, CLIP_MARGIN);
